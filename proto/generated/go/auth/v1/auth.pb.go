...
const file_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x12auth/v1/auth.proto\x12\aauth.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xcf\x01\n" +
	"\x04User\x12\x13\n" +
	...
	"\n" +
	"updated_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tupdatedAt\"d\n" +
	...
	"\bpassword\x18\x03 \x01(\tB\x03\xe0A\x02R\bpassword\"3\n" +
	"\x0eSignupResponse\x12!\n" +
	"\x04user\x18\x01 \x01(\v2\r.auth.v1.UserR\x04user2h\n" +
	"\vAuthService\x12Y\n" +
	"\x06Signup\x12\x16.auth.v1.SignupRequest\x1a\x17.auth.v1.SignupResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/api/v1/auth/signupB\x9f\x01\n" +
	"\vcom.auth.v1B\tAuthProtoP\x01ZHgithub.com/nahualventure/class-backend/proto/generated/go/auth/v1;authv1\xa2\x02\x03AXX\xaa\x02\aAuth.V1\xca\x02\aAuth\\V1\xe2\x02\x13Auth\\V1\\GPBMetadata\xea\x02\bAuth::V1b\x06proto3"
...
var file_auth_v1_auth_proto_depIdxs = []int32{
	3, // 0: auth.v1.User.created_at:type_name -> google.protobuf.Timestamp
	3, // 1: auth.v1.User.updated_at:type_name -> google.protobuf.Timestamp
	0, // 2: auth.v1.SignupResponse.user:type_name -> auth.v1.User
	1, // 3: auth.v1.AuthService.Signup:input_type -> auth.v1.SignupRequest
	2, // 4: auth.v1.AuthService.Signup:output_type -> auth.v1.SignupResponse
